        ...
        <div class="col-lg">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Monto de Pago:</li>
                    <li class="list-group-item">Metodo de Pago:</li>
                    <li class="list-group-item">N° Tarjeta:</li>
                    <li class="list-group-item">N° Cuotas:</li>
