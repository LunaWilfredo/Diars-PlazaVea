...
if(isset($_GET['pagina'])){
    $page = $_GET['pagina'];
    if($page == 'blank' || $page == "ordenDevolucion" || $page == "listaProductos" || $page == "pedidosProveedor" || $page == "retiroAlmacen" || $page == "ventasPagos" || $page == "generarCotizacion" || $page == "buscarProducto" || $page == "generarExchange" || $page == "menuVenta" || $page == "ingresarVenta" || $page == "cotizacionesGeneradas" || $page == "enviarFacturas" || $page == "registroPedidoProveedor" || $page == "actualizarStock" || $page == "consultarVencimiento"|| $page == "registroCotizaciones" || $page == "boletaRefund" ||$page == "404"){
